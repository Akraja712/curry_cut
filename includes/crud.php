...
define('DOMAIN_URL', 'https://currycut.graymatterworks.com/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u743445510_curry_cut";  // Change as required
    private $db_pass = "Curry_Cut@2024";  // Change as required
    private $db_name = "u743445510_curry_cut";    // Change as required
